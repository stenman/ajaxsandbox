...
<body>
	<a href="inc/fromdb.php">Create table from database</a><br>
	<a href="inc/fromcsv.php">Create table from csv file</a><br>
	<a href="inc/fromxml.php">Create table from xml file</a>
</body>
</html>